...
LinkedNode::LinkedNode(int data, LinkedNode * nextNode, LinkedNode * prevNode) : Node(data), nextNode_(nullptr), prevNode_(nullptr) //non-default constructor; //nullptr allows for an initial value; linkedNode_ where nextNode_
{
